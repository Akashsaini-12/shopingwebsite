            ...
            <div className="m-gradient m-color-default">
              <div className="m-custom-content__wrapper m:flex m:flex-wrap">
                <div
                  ...
                  id="m-custom__block--template--15977492021425__7ea56e8d-5794-4708-8812-8ee9604a3a21-1678440566c64de1a8-1"
                >
                      ...
                      <div>
                        ...
                        <noscript>
                          <img
                            ...
                            height=""
                            loading="lazy"
                            src="cdn/shop/files/image-card1_26dbdee9-e640-45db-835b-00d8c15522cc1087.jpg?crop=center&height=2048&v=1709206752&width=2048"
                            width=""
                          />
                        </noscript>
                        {/* </responsive-image> */}
                ...
                <div
                  ...
                  id="m-custom__block--5c5877d5-05b2-4a50-81e3-78c3f6d0d833"
                >
                  <div className="m-custom-content__block-inner m:w-full">
                    ...
                    <div className="m-image-card m-hover-box m-hover-box--scale-up m:w-full m-image-card--button-fixed color-scheme-inherit">
                      <div className="m-image-card__inner  m-gradient m-color-default">
                        <a
                          aria-label="The ReLeather Beige<br> Tennis Shoe5c5877d5-05b2-4a50-81e3-78c3f6d0d833"
                          className="m-image-card__img m:blocks-radius m:block m:h-full"
                          href="zh/collections/women-shoes.html"
                          style={{
                            "--aspect-ratio": "1.0666666666666667",
                            "--aspect-ratio-mobile": "1.0653409090909092",
                          }}
                        >
                          <div className="m-media">
                            <picture className="m-media__wrapper m:block m:w-full m:h-full">
                              <source
                                ...
                                srcSet="//fashion.minimog.co/cdn/shop/files/custom-content-mobile.webp?v=1709195281&width=400 400w, //fashion.minimog.co/cdn/shop/files/custom-content-mobile.webp?v=1709195281&width=600 600w, //fashion.minimog.co/cdn/shop/files/custom-content-mobile.webp?v=1709195281&width=800 800w, //fashion.minimog.co/cdn/shop/files/custom-content-mobile.webp?v=1709195281&width=1000 1000w"
                                width="750"
                              />
                              <img
                                fetchpriority="low"
