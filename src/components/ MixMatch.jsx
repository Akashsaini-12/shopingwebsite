            ...
            <div className="m-mixed-layout m-mixed-layout--mobile-scroll">
              <div className="m-mixed-layout__inner m:grid m:grid-1-cols md:m:grid-2-cols lg:m:grid-3-cols">
                <div className="m:column">
                  <m-stl-card
                    className="m-stl-card"
                    data-id="shop_this_look_amDhCa"
                  >
                    <div className="m-stl-card__image">
                      ...
                      >
                        <button className="m-button m-button--white m-stl-card__btn">
                        ...
                        <div className="m-hover-box m-hover-box--scale-up m:blocks-radius">
                          ...
                          >
                            <img
                              ...
                              srcSet="//fashion.minimog.co/cdn/shop/files/lookbook-2.webp?v=1708490777&width=375 375w, //fashion.minimog.co/cdn/shop/files/lookbook-2.webp?v=1708490777&width=550 550w, //fashion.minimog.co/cdn/shop/files/lookbook-2.webp?v=1708490777&width=750 750w, //fashion.minimog.co/cdn/shop/files/lookbook-2.webp?v=1708490777&width=1100 1100w, //fashion.minimog.co/cdn/shop/files/lookbook-2.webp?v=1708490777&width=1500 1500w"
                              width={906}
                      ...
                      <div className="m-stl-popup m-gradient m-color-default m:blocks-radius-md md:m:blocks-radius-none">
                        <div className="m-stl-popup__heading">
                          <span className="m-stl-popup__title h4">
                            Shop this look
                          </span>
                          <button className="m-stl-popup__close-btn">
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              width={20}
                              height={21}
                        ...
                        <div className="m-stl-popup__wrapper">
                          <div
                            ...
                            data-id="shop_this_look_amDhCa--content"
                          >
                            <a
                            ...
                            <div className="m-stl-product__details">
                              <img
                                src="cdn/shop/files/47871690_900baefb-2629-4a3f-be32-4bde20cbd55253da.jpg?crop=center&height=66&v=1708500574&width=50"
                                alt="Flared Trousers"
                                srcSet="//fashion.minimog.co/cdn/shop/files/47871690_900baefb-2629-4a3f-be32-4bde20cbd552.webp?crop=center&height=66&v=1708500574&width=50 50w"
                                width={50}
                                height={66}
                                loading="lazy"
                              ...
                              <div className="m-stl-product__info">
                                ...
                                <p className="m-stl-product__price">$76.00</p>
                              </div>
                            </div>
                            <button className="m-stl-product__btn m-rlt-reverse-x">
                              <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width={12}
                                height={13}
                          ...
                          >
                            ...
                            <div className="m-stl-product__details">
                              <img
                                src="cdn/shop/files/47871696f279.jpg?crop=center&height=66&v=1708499887&width=50"
                                alt="Short sleeve T-shirt"
                                srcSet="//fashion.minimog.co/cdn/shop/files/47871696.webp?crop=center&height=66&v=1708499887&width=50 50w"
                                width={50}
                                height={66}
                                loading="lazy"
                                className="m:blocks-radius-md"
                              ...
                              <div className="m-stl-product__info">
                                ...
                                <p className="m-stl-product__price">$69.00</p>
                              </div>
                            </div>
                            <button className="m-stl-product__btn m-rlt-reverse-x">
                              <svg
                    ...
                    <div className="m-stl-card__overlay" />
                  </m-stl-card>
                </div>
                <div className="m:column">
                  <m-stl-card
                    className="m-stl-card"
                    data-id="shop_this_look_AVdw3f"
                  >
                    <div className="m-stl-card__image">
                      <div
                        className="m-stl-card__image-wrapper m-scroll-trigger animate--fade-in-up"
                      ...
                      <div className="m-stl-popup m-gradient m-color-default m:blocks-radius-md md:m:blocks-radius-none">
                        ...
                        <div className="m-stl-popup__wrapper">
                          <div
                            className="m-stl-product"
                            data-id="shop_this_look_AVdw3f--content"
                          >
                            <a
                            ...
                            <div className="m-stl-product__details">
                              <img
                                src="cdn/shop/files/47871684_b7ade5f4-d637-43d3-a3fe-ee6aebfb1496e16f.jpg?crop=center&height=66&v=1708500459&width=50"
                                alt="Bardot Sweater"
                                srcSet="//fashion.minimog.co/cdn/shop/files/47871684_b7ade5f4-d637-43d3-a3fe-ee6aebfb1496.webp?crop=center&height=66&v=1708500459&width=50 50w"
                                width={50}
                                height={66}
                                loading="lazy"
                                className="m:blocks-radius-md"
                              ...
                              <div className="m-stl-product__info">
                                ...
                                <p className="m-stl-product__price">$105.00</p>
                              </div>
                            </div>
                            <button className="m-stl-product__btn m-rlt-reverse-x">
                              <svg
                          ...
                          >
                            ...
                            <div className="m-stl-product__details">
                              <img
                                src="cdn/shop/files/47871691_14249914-e5f0-4795-b269-2b82037de0e4dca0.jpg?crop=center&height=66&v=1709200976&width=50"
                                alt="Flared Grey"
                                srcSet="//fashion.minimog.co/cdn/shop/files/47871691_14249914-e5f0-4795-b269-2b82037de0e4.webp?crop=center&height=66&v=1709200976&width=50 50w"
                                width={50}
                                height={66}
                                loading="lazy"
                                className="m:blocks-radius-md"
                ...
                <div className="m:column">
                  ...
                  >
                    <div className="m-stl-card__image">
                        ...
                        <div className="m-hover-box m-hover-box--scale-up m:blocks-radius">
                          ...
                          >
                            <img
                              ...
                              srcSet="//fashion.minimog.co/cdn/shop/files/lookbook-4.webp?v=1708490777&width=375 375w, //fashion.minimog.co/cdn/shop/files/lookbook-4.webp?v=1708490777&width=550 550w, //fashion.minimog.co/cdn/shop/files/lookbook-4.webp?v=1708490777&width=750 750w, //fashion.minimog.co/cdn/shop/files/lookbook-4.webp?v=1708490777&width=1100 1100w, //fashion.minimog.co/cdn/shop/files/lookbook-4.webp?v=1708490777&width=1500 1500w"
                              width={906}
                              height="1268.9999999999998"
                              loading="lazy"
                              fetchpriority="low"
                      ...
                      <div className="m-stl-popup m-gradient m-color-default m:blocks-radius-md md:m:blocks-radius-none">
                        ...
                        <div className="m-stl-popup__wrapper">
                          <div
                            className="m-stl-product"
                            data-id="shop_this_look_EcLGgQ--content"
                          >
                            <a
                            ...
                            <div className="m-stl-product__details">
                              <img
                                src="cdn/shop/products/47871697bc7f.jpg?crop=center&height=66&v=1708332609&width=50"
                                alt="The Cotton Tan"
                                srcSet="//fashion.minimog.co/cdn/shop/products/47871697.webp?crop=center&height=66&v=1708332609&width=50 50w"
                                width={50}
                                height={66}
                                loading="lazy"
                                className="m:blocks-radius-md"
                              ...
                              <div className="m-stl-product__info">
                                ...
                                <p className="m-stl-product__price">$58.00</p>
                              </div>
                            </div>
                            <button className="m-stl-product__btn m-rlt-reverse-x">
                              <svg
                          ...
                          >
                            ...
                            <div className="m-stl-product__details">
                              <img
                                src="cdn/shop/files/47871702_07417b37-03d2-4c1e-919d-21431f912a81b8f5.jpg?crop=center&height=66&v=1708499674&width=50"
                                alt="Faded Effect Jean"
                                srcSet="//fashion.minimog.co/cdn/shop/files/47871702_07417b37-03d2-4c1e-919d-21431f912a81.webp?crop=center&height=66&v=1708499674&width=50 50w"
                                width={50}
                                height={66}
                                loading="lazy"
                                className="m:blocks-radius-md"
                              ...
                              <div className="m-stl-product__info">
                                ...
                                <p className="m-stl-product__price">$87.00</p>
                              </div>
                            </div>
                            <button className="m-stl-product__btn m-rlt-reverse-x">
                              <svg
                    ...
                    <div className="m-stl-card__heading m:text-center m:text-base">
                      <a href="#">
                        The t-shirt is designed with a crewneck collar.
                      </a>
                    </div>
                    <div className="m-stl-card__overlay" />
                  </m-stl-card>
