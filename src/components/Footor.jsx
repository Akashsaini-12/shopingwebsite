  ...
  return (
    <div>
       <div
        ...
        >
          <link
            href="cdn/shop/t/10/assets/footer4754.css?v=184147594002676474491709194135"
            rel="stylesheet"
            type="text/css"
            media="all"
          />
                ...
                <div className="m-footer--accordion">
                  <div className="m-footer--block m-footer--block-newsletter m-accordion--item open order-first m:w-full lg:m:w-1/2">
                    ...
                    >
                      ...
                      <div className="m-accordion--item-content m-footer--block-content">
                        ...
                        <link
                          href="cdn/shop/t/10/assets/component-newsletter96c7.css?v=65459726786247542281739161075"
                          rel="stylesheet"
                          type="text/css"
                          media="all"
                        />
                  ...
                  <div className="m-footer--block m-footer--block-menu m-accordion--item m:w-full lg:m:w-1/4">
                    ...
                    >
                      ...
                      <ul className="m-footer--block-content list-unstyled m-link-lists m-accordion--item-content">
                        <li className="m-link-lists--item m:block">
                          <a
                        ...
                        <li className="m-link-lists--item m:block">
                          <a href="zh/cart.html" className="m-link">
                            Cart
                          </a>
                        </li>
                        <li className="m-link-lists--item m:block">
                          <a href="zh/pages/wishlist.html" className="m-link">
                            Wishlist
                          </a>
                        </li>
                        <li className="m-link-lists--item m:block">
                  ...
                  <div className="m-footer--block m-footer--block-menu m-accordion--item m:w-full lg:m:w-1/4">
                    ...
                    >
                      ...
                      <ul className="m-footer--block-content list-unstyled m-link-lists m-accordion--item-content">
                        <li className="m-link-lists--item m:block">
                          <a href="zh/pages/about-us.html" className="m-link">
                            About Us
                          </a>
                        </li>
                        <li className="m-link-lists--item m:block">
                          <a href="zh/pages/careers.html" className="m-link">
                            Careers
                          </a>
                        </li>
                        <li className="m-link-lists--item m:block">
                        ...
                        <li className="m-link-lists--item m:block">
                          <a
                            href="zh/pages/privacy-policy.html"
                            className="m-link"
                          >
                            Privacy Policy
                          </a>
                ...
                <div className="m-footer--bottom-inner m:flex m:flex-col xl:m:flex-row m:justify-between m:items-end">
                  ...
                  <div className="m-footer--bottom-right m:w-full m:flex-col lg:m:flex-row m:flex m:flex-wrap xl:m:justify-end">
                    ...
                    <ul className="m-footer--bottom-menu m-link-lists m-link-lists--inline xl:m:justify-end show-menu-item-divider">
                      <li className="m-footer--bottom-menu-item m-link-lists--item">
                        <a
                          className="m-link"
                          href="zh/pages/privacy-policy.html"
                        >
                      ...
                      <li className="m-footer--bottom-menu-item m-link-lists--item">
                        <a
                          className="m-link"
                          href="zh/pages/shipping-delivery.html"
                        >
                          Appoinments
                        </a>
                      </li>
